...
const uiText = {
  en: {
    ...
    selectors: {
      ...
      '[data-i18n="hero-heading"]': "Move from “What is this property worth?” to “Is this a smart opportunity?”",
      '[data-i18n="hero-estimate-eyebrow"]': "Free first-layer estimate",
      '[data-i18n="hero-sub"]': "Get a first-layer valuation, understand suburb opportunity signals, and review planning constraints before you make a property decision.",
      ...
      '[data-i18n="funnel-watch-copy"]': "Save suburbs and properties, track Future Opportunity Scores and monitor planning signals when new data is available. Coming Soon.",
      ...
      '[data-i18n="research-sub"]': "Explore AusHomeValue suburb intelligence alongside curated research from leading Australian property data sources.",
      ...
      '[data-i18n="investor-watch-full-report-price"]': "Included with subscription",
      '[data-i18n="investor-watch-full-report-copy"]': "Active subscribers receive full valuation reports without a separate AUD $3.99 purchase.",
      ...
      '[data-i18n="investor-watch-coming-soon"]': "Join Investor Watch — Coming Soon",
      '[data-i18n="investor-watch-note"]': "No payment setup required. We will notify you when it opens.",
  ...
  zh: {
    ...
    selectors: {
      ...
      '[data-i18n="hero-heading"]': "不只是知道房子值多少钱，而是判断它是不是值得关注的机会。",
      '[data-i18n="hero-estimate-eyebrow"]': "免费估值（首层）",
      '[data-i18n="hero-sub"]': "先获得初步估值，再结合区域机会信号和规划约束，帮助你更清楚地做买房判断。",
      ...
      '[data-i18n="visual-planning-value"]': "分区 + Overlay",
      ...
      '[data-i18n="funnel-report-copy"]': "解锁这一套房的可比成交证据、规划与分区信号、Future Opportunity Outlook、关键风险和数据限制。",
      '[data-i18n="funnel-watch-step"]': "第三层",
      '[data-i18n="funnel-watch-title"]': "Investor Watch — AUD $9.99/月",
      '[data-i18n="funnel-watch-copy"]': "收藏区域和房产，在有新数据时跟踪 Future Opportunity Score 与规划信号变化。即将开放。",
      '[data-i18n="product-difference-copy"]': "Top Opportunity 帮你发现该看哪里。Investor Watch 帮你持续跟踪你关心的区域和房产。",
      '[data-i18n="stat-sales"]': "条成交记录已收录",
      '[data-i18n="stat-schools"]': "所学校已标注",
      '[data-i18n="stat-suburbs"]': "个区域有成交覆盖",
      ...
      '[data-i18n="research-sub"]': "浏览 AusHomeValue 区域情报，并参考澳洲领先房地产数据源的精选研究。",
      ...
      '[data-i18n="investor-watch-full-report-price"]': "订阅期间免费包含",
      '[data-i18n="investor-watch-full-report-copy"]': "有效订阅用户无需另付 AUD $3.99，即可获取完整估值报告。",
      ...
      '[data-i18n="investor-watch-coming-soon"]': "加入 Investor Watch — 即将开放",
      '[data-i18n="investor-watch-note"]': "无需预先设置支付。开放时会通知你。",
  ...
  try {
    ...
    if (result.estimate && !result.valuation) {
      ...
      return {
        ...
        experimentalLabel: result.experimentalLabel || null,
        modelVersion: "",
...
byId("start-valuation").addEventListener("click", async () => {
  ...
  const inferredType = inferPropertyTypeFromAddress(canonicalAddress || byId("address").value, null, currentActive);
  if (inferredType) {
