...
const uiText = {
  en: {
    ...
    selectors: {
      ...
      '[data-i18n="nav-research"]': "Research",
      '[data-i18n="nav-blog"]': "Suburb Research",
      '[data-i18n="nav-about"]': "About Us",
      '[data-i18n="nav-methodology"]': "Methodology",
      '[data-i18n="nav-contact"]': "Contact",
      '[data-i18n="nav-get-estimate"]': "Get estimate",
      ...
      '[data-i18n="hero-estimate-cta"]': "Estimate a property",
      '[data-i18n="visual-estimate-label"]': "Estimate",
      '[data-i18n="visual-estimate-value"]': "Value range",
      '[data-i18n="visual-future-label"]': "Future Score",
      '[data-i18n="visual-future-value"]': "Opportunity outlook",
      '[data-i18n="visual-planning-label"]': "Planning Signal",
      '[data-i18n="visual-planning-value"]': "Zone + overlay",
      '[data-i18n="funnel-free-step"]': "Step 1",
      '[data-i18n="funnel-free-title"]': "Free Estimate",
      '[data-i18n="funnel-free-copy"]': "A first-layer value range, confidence level and basic evidence summary.",
      '[data-i18n="funnel-report-step"]': "Step 2",
      '[data-i18n="funnel-report-title"]': "Full Valuation Report — AUD $3.99 one-time",
      '[data-i18n="funnel-report-copy"]': "Unlock comparable sales evidence, planning and zoning signals, Future Opportunity Outlook, key risks and data limitations for one property.",
      '[data-i18n="funnel-watch-step"]': "Step 3",
      '[data-i18n="funnel-watch-title"]': "Investor Watch — AUD $9.99/month",
      '[data-i18n="funnel-watch-copy"]': "Save suburbs and properties, track Future Opportunity Scores and monitor planning signals when new data is available.",
      '[data-i18n="product-difference-copy"]': "Top Opportunity helps you discover where to look. Investor Watch helps you keep watching what matters.",
      '[data-i18n="stat-sales"]': "sales records indexed",
      '[data-i18n="stat-schools"]': "schools mapped",
      '[data-i18n="stat-suburbs"]': "suburbs with sales coverage",
      '[data-i18n="stats-freshness"]': "Sales data updated weekly",
      '[data-i18n="report-preview-eyebrow"]': "What the AUD $3.99 report includes",
      '[data-i18n="report-preview-comps"]': "Comparable sales evidence and valuation range",
      '[data-i18n="report-preview-planning"]': "Planning, zoning and overlay signals where available",
      '[data-i18n="report-preview-outlook"]': "Future Opportunity Outlook, key risks and data limitations",
      '[data-i18n="report-preview-cta"]': "Preview the full report →",
      '[data-i18n="own-suburb-research"]': "Explore AusHomeValue Suburb Research →",
      '[data-i18n="own-rankings"]': "Explore AusHomeValue Rankings →",
      ...
      '[data-i18n="research-sub"]': "AusHomeValue suburb analysis alongside selected Australian market and government research.",
      '[data-i18n="opp-preview-eyebrow"]': "Ranked Opportunities",
      '[data-i18n="opp-preview-heading"]': "Discover Victoria's top investment opportunities.",
      '[data-i18n="opp-preview-sub"]': "Data-driven rankings across growth, value, rental yield and school zones. Sales inputs are refreshed weekly.",
      '[data-i18n="opp-preview-cta"]': "View full ranking →",
      ...
      '[data-i18n="investor-watch-price"]': "AUD $9.99/month",
      '[data-i18n="investor-watch-price-copy"]': "For ongoing monitoring across saved suburbs and properties.",
      '[data-i18n="investor-watch-full-report-label"]': "Full Valuation Report",
      '[data-i18n="investor-watch-full-report-price"]': "AUD $3.99 one-time",
      '[data-i18n="investor-watch-full-report-copy"]': "For one property: valuation evidence, planning signals and future outlook.",
      '[data-i18n="investor-watch-feature-1"]': "Save suburbs and properties to a watchlist",
      '[data-i18n="investor-watch-feature-2"]': "Track Future Opportunity Scores",
      '[data-i18n="investor-watch-feature-3"]': "Monitor zoning and overlay signals when new data is available",
      '[data-i18n="investor-watch-feature-4"]': "Compare multiple properties before buying",
      '[data-i18n="investor-watch-coming-soon"]': "Open Investor Watch — Free Preview",
      '[data-i18n="investor-watch-billing-note"]': "Subscription billing is not active during the free preview.",
      '[data-i18n="investor-watch-note"]': "Free preview. No payment setup required.",
      '[data-i18n="methodology-eyebrow"]': "Methodology",
      '[data-i18n="methodology-heading"]': "How AusHomeValue builds a practical buying view.",
      '[data-i18n="methodology-card1-title"]': "Valuation evidence",
      '[data-i18n="methodology-card1-copy"]': "We start with comparable sales, property type, suburb context and confidence checks.",
      '[data-i18n="methodology-card2-title"]': "Opportunity signals",
      '[data-i18n="methodology-card2-copy"]': "We combine suburb fundamentals, Future Opportunity Scores and market evidence into a directional view.",
      '[data-i18n="methodology-card3-title"]': "Planning signals",
      '[data-i18n="methodology-card3-copy"]': "We surface zoning and overlay signals where available, with limitations clearly stated.",
      '[data-i18n="methodology-note"]': "General information only. Not financial advice, not a formal valuation and not development approval advice."
    }
  },
  zh: {
    toggle: "English",
    selectors: {
      ...
      '[data-i18n="nav-blog"]': "区域研究",
      '[data-i18n="nav-about"]': "关于我们",
      '[data-i18n="nav-methodology"]': "方法说明",
      '[data-i18n="nav-contact"]': "联系",
      '[data-i18n="nav-get-estimate"]': "开始估值",
      ...
      '[data-i18n="hero-estimate-cta"]': "估算一套房产",
      '[data-i18n="visual-estimate-label"]': "估值",
      '[data-i18n="visual-estimate-value"]': "价格区间",
      '[data-i18n="visual-future-label"]': "未来机会评分",
      '[data-i18n="visual-future-value"]': "机会展望",
      '[data-i18n="visual-planning-label"]': "规划信号",
      '[data-i18n="visual-planning-value"]': "分区与规划覆盖",
      '[data-i18n="funnel-free-step"]': "第一层",
      '[data-i18n="funnel-free-title"]': "免费估值",
      '[data-i18n="funnel-free-copy"]': "先查看初步估值区间、置信度和基础证据摘要。",
      '[data-i18n="funnel-report-step"]': "第二层",
      '[data-i18n="funnel-report-title"]': "完整估值报告 — AUD $3.99 一次性",
      '[data-i18n="funnel-report-copy"]': "解锁这一套房的可比成交证据、规划与分区信号、未来机会展望、关键风险和数据限制。",
      '[data-i18n="funnel-watch-step"]': "第三层",
      '[data-i18n="funnel-watch-title"]': "Investor Watch — AUD $9.99/月",
      '[data-i18n="funnel-watch-copy"]': "收藏区域和房产，在有新数据时跟踪未来机会评分与规划信号变化。",
      '[data-i18n="product-difference-copy"]': "机会榜单帮你发现该看哪里；机会监控帮你持续跟踪关心的区域和房产。",
      '[data-i18n="stat-sales"]': "条成交记录已收录",
      '[data-i18n="stat-schools"]': "所学校已标注",
      '[data-i18n="stat-suburbs"]': "个区域有成交数据",
      '[data-i18n="stats-freshness"]': "成交数据每周更新",
      '[data-i18n="report-preview-eyebrow"]': "AUD $3.99 完整报告包含什么",
      '[data-i18n="report-preview-comps"]': "可比成交证据与估值区间",
      '[data-i18n="report-preview-planning"]': "数据可用时提供规划、分区与覆盖信号",
      '[data-i18n="report-preview-outlook"]': "未来机会展望、关键风险与数据限制",
      '[data-i18n="report-preview-cta"]': "预览完整报告 →",
      '[data-i18n="own-suburb-research"]': "查看 AusHomeValue 区域研究 →",
      '[data-i18n="own-rankings"]': "查看 AusHomeValue 排行榜 →",
      ...
      '[data-i18n="research-sub"]': "AusHomeValue 区域分析，并结合精选的澳洲市场与政府研究资料。",
      '[data-i18n="opp-preview-eyebrow"]': "投资机会排名",
      '[data-i18n="opp-preview-heading"]': "发现维州值得进一步研究的投资机会。",
      '[data-i18n="opp-preview-sub"]': "从增长、价值、租金收益和学校等角度展示相对排名；成交数据每周更新。",
      '[data-i18n="opp-preview-cta"]': "查看完整排名 →",
      ".opp-preview-card:nth-child(1) h3": "📈 增长排名",
      ".opp-preview-card:nth-child(1) .opp-preview-desc": "结合价格趋势、学校、收益和空置情况。",
      ".opp-preview-card:nth-child(2) h3": "💎 价值排名",
      ".opp-preview-card:nth-child(2) .opp-preview-desc": "寻找价格相对可负担且具备上行空间的区域。",
      ".opp-preview-card:nth-child(3) h3": "💰 收益排名",
      ".opp-preview-card:nth-child(3) .opp-preview-desc": "关注现金流与租金回报。",
      ".opp-preview-card:nth-child(4) h3": "🏫 学校排名",
      ".opp-preview-card:nth-child(4) .opp-preview-desc": "比较学校资源相对较强的区域。",
      ...
      '[data-i18n="investor-watch-price-label"]': "Investor Watch",
      '[data-i18n="investor-watch-price"]': "AUD $9.99/月",
      '[data-i18n="investor-watch-price-copy"]': "用于持续监控收藏区域和房产。",
      '[data-i18n="investor-watch-full-report-label"]': "完整估值报告",
      '[data-i18n="investor-watch-full-report-price"]': "AUD $3.99 一次性",
      '[data-i18n="investor-watch-full-report-copy"]': "用于一套房：估值证据、规划信号和未来机会展望。",
      '[data-i18n="investor-watch-feature-1"]': "收藏区域和房产到观察清单",
      '[data-i18n="investor-watch-feature-2"]': "跟踪 Future Opportunity Score",
      '[data-i18n="investor-watch-feature-3"]': "有新数据时监控分区和 Overlay 信号",
      '[data-i18n="investor-watch-feature-4"]': "买房前对比多套房产",
      '[data-i18n="investor-watch-coming-soon"]': "打开 Investor Watch — 免费预览",
      '[data-i18n="investor-watch-billing-note"]': "免费预览期间不会扣费。",
      '[data-i18n="investor-watch-note"]': "免费预览，无需设置付款。",
      '[data-i18n="methodology-eyebrow"]': "方法说明",
      '[data-i18n="methodology-heading"]': "AusHomeValue 如何形成实用的买房判断视图。",
      '[data-i18n="methodology-card1-title"]': "估值证据",
      '[data-i18n="methodology-card1-copy"]': "我们先看可比成交、房产类型、区域背景和置信度检查。",
      '[data-i18n="methodology-card2-title"]': "机会信号",
      '[data-i18n="methodology-card2-copy"]': "我们结合区域基本面、Future Opportunity Score 和市场证据，形成方向性判断。",
      '[data-i18n="methodology-card3-title"]': "规划信号",
      '[data-i18n="methodology-card3-copy"]': "在数据可用时，我们展示分区和 Overlay 信号，并明确说明限制。",
      '[data-i18n="methodology-note"]': "仅供一般信息参考。不构成财务建议、正式估值或开发审批建议。"
    }
  }
};
  ...
  try {
    ...
    if (result.estimate && !result.valuation) {
      ...
      return {
        ...
        location: result.location || emptyValuation.location,
        planning: result.planning || emptyValuation.planning,
...
byId("start-valuation").addEventListener("click", async () => {
  ...
  document.body.classList.add("valuation-started");
