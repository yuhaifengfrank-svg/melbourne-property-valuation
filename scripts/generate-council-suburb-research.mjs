...
<html lang="zh-CN"><head>
  ...
  <section class="overview"><div class="section-kicker">SUBURB RESEARCH V2 · VERIFIED PLANNING EVIDENCE</div><h2>目前可以可靠发布什么？</h2><p>${escapeHtml(evidenceType)}</p><p>本页只显示已通过发布门槛的规划证据。房价、租金、人口、就业或空置率在没有相同地理口径的可靠数据前不会补零、推测或沿用旧值。</p></section>
  ${sections}
...
<html lang="zh-CN"><head>
  ...
  <p class="intro">每个页面把直接suburb事实、Council或统计区域背景和模型估算分开呈现。没有可靠来源或定义不清的指标不会发布。</p>
  ...
  <div class="summary"><strong>${totalSuburbs}个区域 · ${councilGroups.size}个已处理Council</strong><br>规划证据均来自已合并的官方来源汇总；跨Council suburb分别保留各Council口径。</div>
