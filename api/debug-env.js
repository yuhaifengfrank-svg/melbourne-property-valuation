export default async function handler(req, res) {
  ...
  const info = {
    ...
    expectedHost: env.PREVIEW_DATABASE_HOST || '(not set)',
    actualHost: actualHost,
    match: actualHost && env.PREVIEW_DATABASE_HOST ? actualHost === env.PREVIEW_DATABASE_HOST : null,
    hostLengthExpected: env.PREVIEW_DATABASE_HOST ? env.PREVIEW_DATABASE_HOST.length : 0,
    hostLengthActual: actualHost ? actualHost.length : 0,
  };
