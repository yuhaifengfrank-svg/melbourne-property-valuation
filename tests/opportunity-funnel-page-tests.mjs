...
test("homepage Future Outlook renders separate strategy rankings", () => {
  assert.match(app, /balanced: \{ label: 'Balanced Outlook'/);
  assert.match(app, /growth:\s+\{ label: 'Growth Outlook'/);
