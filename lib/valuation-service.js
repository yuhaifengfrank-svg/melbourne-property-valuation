...
function overridePropertyTypeFromAddress(address, incomingType) {
  ...
  const hasUnitSignal = /\bunit\s+\d+\b|\bunit\b|\b\d+\s*\/\s*\d+\b|\bflat\b|^\d+\s*\//.test(normalized);
